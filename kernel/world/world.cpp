...
std::vector<geometry::Triangle> GlobalObject::GetTrianglesForWorker(int32_t begin,
                                                                    int32_t end) const {
  std::vector<geometry::Triangle> triangles;
...
int32_t GlobalObject::TrianglesCount() const { return local_object.GetTriangles().size(); }
